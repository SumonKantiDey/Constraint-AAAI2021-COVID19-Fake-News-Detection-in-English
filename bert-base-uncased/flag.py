...
def get_parser():
    ...
    parser.add_argument("-m_path", "--model_path", type=str, default='/content/drive/MyDrive/COVID19 Fake News Detection in English/bert-base-uncased/store_model/',help="Save best model")
    ...
    parser.add_argument("--model_specification", default="Bert Base Uncased", required=False, help="model name")
    parser.add_argument("--bert_path", default="/content/drive/My Drive/pre_trained_model/bert-base-uncased/", required=False, help="Pretrained model name")
