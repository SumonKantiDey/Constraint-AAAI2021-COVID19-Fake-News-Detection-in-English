...
def get_parser():
    ...
    parser.add_argument("-m_path", "--model_path", type=str, default='../store_model/roberta_model.bin',help="Save best model")
    ...
    parser.add_argument("--model_specification", default="Roberta Base Uncased", required=False, help="model name")
    parser.add_argument("--pretrained_model_name", default="roberta-base", required=False, help="Pretrained model name")
    parser.add_argument("--roberta_hidden", default=768, type=int, metavar='N', help='Number of layer for bert')
