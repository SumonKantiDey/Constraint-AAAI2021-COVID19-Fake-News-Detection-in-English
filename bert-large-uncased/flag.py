...
def get_parser():
    ...
    parser.add_argument("-m_path", "--model_path", type=str, default='/content/drive/MyDrive/COVID19 Fake News Detection in English/bert-large-uncased/store_model/',help="Save best model")
    ...
    parser.add_argument("--model_specification", default="Bert Large Uncased", required=False, help="model name")
    parser.add_argument("--bert_path", default="/content/drive/My Drive/pre_trained_model/bert-large-uncased/", required=False, help="Pretrained model name")
    parser.add_argument("--bert_hidden", default=1024, type=int, metavar='N', help='Number of layer for bert')
