...
# LOGGER's
LOGGER_DEBUG_FILE = '../bert-large-uncased/logs/debug.log'
LOGGER_INFO_FILE = '../bert-large-uncased/logs/info.log'
LOGGER_ERROR_FILE = '../bert-large-uncased/logs/error.log'
