...
# LOGGER's
LOGGER_DEBUG_FILE = '../bert-base-uncased-wordpiece/logs/debug.log'
LOGGER_INFO_FILE = '../bert-base-uncased-wordpiece/logs/info.log'
LOGGER_ERROR_FILE = '../bert-base-uncased-wordpiece/logs/error.log'
