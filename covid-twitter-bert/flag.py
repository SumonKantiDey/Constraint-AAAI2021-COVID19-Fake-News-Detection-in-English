...
def get_parser():
    ...
    parser.add_argument("-m_path", "--model_path", type=str, default='/content/drive/MyDrive/COVID19 Fake News Detection in English/covid-twitter-bert/store_model/',help="Save best model")
    ...
    parser.add_argument("--pretrained_model_name", default="digitalepidemiologylab/covid-twitter-bert", required=False, help="Pretrained model name")
