...
# LOGGER's
LOGGER_DEBUG_FILE = '/content/drive/My Drive/COVID19 Fake News Detection in English/covid-twitter-bert/logs/debug.log'
LOGGER_INFO_FILE = '/content/drive/My Drive/COVID19 Fake News Detection in English/covid-twitter-bert/logs/info.log'
LOGGER_ERROR_FILE = '/content/drive/My Drive/COVID19 Fake News Detection in English/covid-twitter-bert/logs/error.log'
