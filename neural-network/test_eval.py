...
def test_evaluation(tokenizer,model, device):
    #shuffling the data
    np.random.seed(args.seed)
...
if __name__ == "__main__":
    #test_evaluation()
    dfx = pd.read_csv('/content/drive/My Drive/COVID19 Fake News Detection in English/neural-network/output/vanilla_lstm32.csv')
